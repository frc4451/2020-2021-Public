...
public class ShooterSub extends SubsystemBase {
	...
	public ShooterSub(TalonFX kSFalcon) {
		...
		kShooterFalcon.configNominalOutputForward(0, Constants.kTimeoutMs);
		kShooterFalcon.configNominalOutputReverse(0, Constants.kTimeoutMs);
		kShooterFalcon.configPeakOutputForward(1, Constants.kTimeoutMs);
		kShooterFalcon.configPeakOutputReverse(-1, Constants.kTimeoutMs);
